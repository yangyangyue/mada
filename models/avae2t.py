...
class Avae2tNet(nn.Module):
    def __init__(self, mid_channels=64, out_channels=256, window_size=1024):
        ...
        self.z_mu = nn.Linear(out_channels * length * 2, length)
        self.z_log_var = nn.Linear(out_channels * length * 2, length)
    ...
    def forward(self, examples, aggs, apps=None):
        ...
        # encoder
        y10 = self.layer1_0(aggs[:, None, :])
        y11 = self.layer1_1(y10)
        y20 = self.layer2_0(y11)
        y21 = self.layer2_1(y20)
        y30 = self.layer3_0(y21)
        y31 = self.layer3_1(y30)
        y40 = self.layer4_0(y31)
        y41 = self.layer4_1(y40)
        y50 = self.layer5_0(y41)
        y51 = self.layer5_1(y50)
        y60 = self.layer6_0(y51)
        y61 = self.layer6_1(y60)
        y70 = self.layer7_0(y61) 
        yflatten = y70.flatten(start_dim=1)
        ...
        z = torch.cat([xflatten, yflatten], dim=1)
        mu = self.z_mu(z)
